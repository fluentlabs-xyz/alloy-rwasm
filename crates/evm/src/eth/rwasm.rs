...
use revm::{context::{BlockEnv, CfgEnv, TxEnv}, context_interface::result::{EVMError, HaltReason, ResultAndState}, handler::{instructions::EthInstructions, EthPrecompiles, PrecompileProvider}, inspector::NoOpInspector, interpreter::{interpreter::EthInterpreter, InterpreterResult}, primitives::hardfork::SpecId, Context, ExecuteEvm, InspectEvm, Inspector, SystemCallEvm};
...
impl<DB: Database, I, PRECOMPILE> EthRwasm<DB, I, PRECOMPILE> {
...
impl<DB: Database, I, PRECOMPILE> Deref for EthRwasm<DB, I, PRECOMPILE> {
...
impl<DB: Database, I, PRECOMPILE> DerefMut for EthRwasm<DB, I, PRECOMPILE> {
    #[inline]
...
impl<DB, I, PRECOMPILE> Evm for EthRwasm<DB, I, PRECOMPILE>
where
    DB: Database,
...
/// Factory producing [`EthRwasm`].
#[derive(Debug, Default, Clone, Copy)]
#[non_exhaustive]
pub struct EthRwasmFactory;

impl EvmFactory for EthRwasmFactory {
    type Evm<DB: Database, I: Inspector<EthRwasmContext<DB>>> = EthRwasm<DB, I, Self::Precompiles>;
    ...
    fn create_evm<DB: Database>(&self, db: DB, input: EvmEnv) -> Self::Evm<DB, NoOpInspector> {
        ...
        EthRwasm {
            inner: Context::rwasm()
                ...
                .with_precompiles(PrecompilesMap::from_static(RwasmPrecompiles::new_with_spec(spec_id).precompiles())),
            inspect: false,
        }
    }
